...
let q9a = (billA + ((tipA/100) * billA));
console.log(`€${billA} + ${tipA}% = ${q9a}`);
let q9b = (billB + ((tipB/100) * billB));
console.log(`€${billB} + ${tipB}% = ${q9b}`);
let q9c = (billC + ((tipC/100) * billC));
console.log(`€${billC} + ${tipC}% = ${q9c}`);
...
let daysWorked = 10
let hoursWorked = (8 + 6 + 5 + 9 + 8 + 2 + 1 + 8.5 + 7 + 4)
let q10 = ("Noemy's average working day over the last two weeks = " + hoursWorked/daysWorked + " hours.")
console.log(q10)
